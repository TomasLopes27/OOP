...
public class ShoulderPress extends Atividade implements AtividadePesos, AtividadeRepeticoes{
     ...
     * @param reps repeticoes da atividade
     * @param peso peso
     * @param horas horas da atividade
     */
    public ShoulderPress(int codigo, int duracao, LocalDate data, double frequencia_cardiaca,
     ...
     * @param sp a copiar
     */
    public ShoulderPress (ShoulderPress sp) {
        super(sp);
        this.calorias_gastas = sp.getCalorias_gastas();
        this.peso = sp.getPeso();
        this.reps = sp.getNumReps();
    }
    ...
    @Override
    public ShoulderPress clone() {
        return new ShoulderPress(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        ShoulderPress sp = (ShoulderPress) o;
        return this.reps == sp.getNumReps()
                && this.peso == sp.getPeso()
                && this.calorias_gastas == sp.getCalorias_gastas();
    }
